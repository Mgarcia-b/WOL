...
require "./dbs.php";
  ...
  $mi_host = $_SERVER["HTTP_HOST"];
    ...
    $myfile = fopen("SM_PRUEBA.json", "w") or die("Error archivo");
    $txt = $json_pretty;
    fwrite($myfile, $txt);
    fclose($myfile);
    //Leemos el archivo creado
    $JsonParser = file_get_contents("SM_PRUEBA.json");
    ...
    $insert_bitacora = "INSERT INTO `DBTEST`.`BITACORA_PRUEBA` (`FLAG`, `NOMBRE_JSON`) VALUES ('1', 'FB_CAMPANA');";
